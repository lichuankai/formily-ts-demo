...
export const ResourceWidget: React.FC<IResourceWidgetProps> = observer(
  (props: { defaultExpand: any; sources: any[]; className: string | number | boolean | Mapping | Argument[]; title: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | React.ReactFragment | React.ReactPortal; children: unknown }) => {
    ...
    const sources = props.sources.reduce<IResource[]>((buf: any[], source: { Resource: any }) => {
    ...
    const remainItems =
      sources.reduce((length: any, source: { span: any }) => {
